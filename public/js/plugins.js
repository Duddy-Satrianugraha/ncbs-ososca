$(function() {
    ...
    var uiElements = function(){
        ...
        var uiSummernote = function(){
            ...
            /* Osin summernote editor */
            if($(".summernote_osix").length > 0){

                $(".summernote_osix").summernote({height: 250, focus: true,
                                                  toolbar: [
                                                      ['style', ['bold', 'italic', 'underline', 'clear']],
            ...
            /* Osin summernote editor */
            if($(".summernote_osin_picc").length > 0){

                $(".summernote_osin_picc").summernote({height: 250, focus: true,
                                                  toolbar: [
                                                      ['style', ['bold', 'italic', 'underline', 'clear']],
                                                      ['font', ['strikethrough', 'fontsize']],
                                                      ['fontstyle', ['fontname']],
