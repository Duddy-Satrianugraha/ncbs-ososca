    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body form-group-separated">
                ...
                <div class="form-group">
                    <label class="col-md-3 col-xs-12 control-label">Pretest</label>
                    <div class="col-md-6 col-xs-12">
                        <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-users"></span></span>
                            <input type="number" name="pretest" class="form-control" value="{{ $detail->pretest }}"/>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 col-xs-12 control-label">PostTest</label>
                    <div class="col-md-6 col-xs-12">
                        <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-users"></span></span>
                            <input type="number" name="posttest" class="form-control" value="{{ $detail->posttest }}"/>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-users"></span></span>
                            <input type="number" name="laporan" class="form-control" value="{{ $detail->laporan }}"/>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 col-xs-12 control-label">Ujian Praktikum</label>
                    <div class="col-md-6 col-xs-12">
                        <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-users"></span></span>
                            <input type="number" name="ujian_prax" class="form-control" value="{{ $detail->ujian_prax }}"/>
                        </div>
                    </div>
                </div>
                <div class="form-group">
