...
@section('breadcrumb')
   ...
   <ul class="breadcrumb">
    ...
    <li ><a href="{{ route('nilai.index')}}">Daftar Ujian</a></li>
        <li class="active">Import Sesi Baru Nilai PBL Baru</li>
</ul>
<!-- END BREADCRUMB -->
@endsection
@section('page-title')
...
<div class="row">
    <div class="col-md-12">
        ...
        <form class="form-horizontal" action="{{ route('nilai.pbl.upload', $allnilai->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="panel-body form-group-separated">
                ...
                <div class="form-group">
                    <label class="col-md-3 col-xs-12 control-label">
                        <P> <strong>Penduan Import Nilai PBL</strong> </br>
                            <span class="fa fa-exclamation-triangle"> Pastikan Nama dan NPM mahasiswa sudah sesuai</span> </br>
                            <span class="fa fa-exclamation-triangle"> File excel harus sesuai dengan output CBS-Pbl </span></br>
