...
@section('breadcrumb')
   ...
   <ul class="breadcrumb">
    ...
    <li ><a href="{{ route('nilai.index')}}">Daftar Ujian</a></li>
        <li class="active">Import Nilai CBT Baru</li>
</ul>
<!-- END BREADCRUMB -->
@endsection
@section('page-title')
<div class="page-title">
    <h2><span class="fa fa-arrow-circle-o-left"></span> Import Nilai CBT Baru</h2>
</div>
@endsection
@section('content')
...
<div class="row">
    <div class="col-md-12">
        ...
        <form class="form-horizontal" action="{{ route('nilai.cbt.store') }}" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="col-md-8 col-xs-12">
                         <div class="input-group">
                             ...
                             <select name="jenis_nilai" class="form-control">
                                 <option value="UTB">Ujian Tengah Blok</option>
                                 <option value="UAB">Ujian Akhir Blok</option>
                             </select>
                         </div>
                     </div>
                 </div>
