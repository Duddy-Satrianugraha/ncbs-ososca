...
@section('content')
        ...
        <div class="login-title"><strong>Pendaftaran</strong> Penguji</div>
        ...
        <div class="form-group @error('npm') has-error @enderror">
            <div class="col-md-12">
                <input type="text" name='username' class="form-control" value="{{ old('npm') }}" placeholder="Username Penguji"/>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-md-6">
                <a href="{{ route('penguji.login')}}" class="btn btn-link">Sudah pernah daftar ?</a>
            </div>
            <div class="col-md-6">
