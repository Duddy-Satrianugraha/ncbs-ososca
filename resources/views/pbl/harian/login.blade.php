...
<div class="row">
    <div class="col-md-10 col-md-offset-1 card shadow-card">
      ...
      <div class="row">
        <!-- Kiri: Info Station -->
        <div class="col-sm-6">
          <div class="info-title">Login Kelompok PBL</div>
           <div class='col-sm-10'><br><br><br>

          <form action="{{ route('pbl.scan')}}" method="post" class="form-horizontal" id="form-scan">
            @csrf
        ...
        <!-- Panel Tab -->
            <div class="col-sm-6">
                <div class="info-title">Silahkan Arahkan Qr Code Kelompok</div>
