...
<div class="page-title">
    <h2><span class="fa fa-arrow-circle-o-left"></span>Skenario {{ $mininotes->nomor_sk}} PbL {{ $mininotes->keg->name }}</h2>
</div>
@endsection
@section('content')
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body form-group-separated">
                     <div class="form-group">
                        <label class="col-md-2 col-xs-12 control-label">Judul Skenario</label>
                        <div class="col-md-8 col-xs-12">
                            <input type="text" class="form-control" name="judul_sk" value="{{ $mininotes->judul_sk }}"/>
                            <small class="text">Judul Skenario</small>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 col-xs-12 control-label">Skenario</label>
                        <div class="col-md-8 col-xs-12">
                            <textarea class="form-control summernote_osin_pic" name="skenario">{{$mininotes->skenario}}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 col-xs-12 control-label">Daftar Pustaka</label>
                        <div class="col-md-8 col-xs-12">
                            <textarea class="form-control summernote_osin" name="dafpus">{{$mininotes->dafpus}}</textarea>
                        </div>
                    </div>
