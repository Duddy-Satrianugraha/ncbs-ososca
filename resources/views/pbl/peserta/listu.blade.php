...
<div class="page-title">
    <h2><span class="fa fa-arrow-circle-o-left"></span> Daftar Peserta PBL {{ $harian->name }}</h2>
</div>
@endsection
@section('content')
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                  ...
                                  <form action="{{ route('pbl.peserta.index', $harian->id) }}" method="GET" class="row">
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-btn">
                                                ...
                                                <a href="{{ route('pbl.peserta.index', $harian->id) }}" class="btn btn-default">Clear</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
