...
<div class="page-title">
    <h2><span class="fa fa-arrow-circle-o-left"></span> Edit Peserta PBL {{ $harian->name }}  </h2>
</div>
@endsection
@section('content')
...
<div class="row">
    <div class="col-md-12">
        ...
        <form class="form-horizontal" action="{{ route('pbl.peserta.update', $pblPeserta->id) }}" method="POST">
        @csrf
        @method('put')
            <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><strong>Edit Peserta</strong> {{ $pblPeserta->name }}</h3>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="input-group">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ $pblPeserta->name }}"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="input-group">
                            ...
                            <input type="text" name="npm" class="form-control" value="{{ $pblPeserta->npm }}"/>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="input-group">
                            ...
                            @foreach($kelompoks as $kel)
                                <option value="{{ $kel->id }}" @if($pblPeserta->kelompok_id == $kel->id) selected @endif>{{ $kel->nama_kelompok }}</option>
                            @endforeach
                            </select>
                        </div>
                    </div>
